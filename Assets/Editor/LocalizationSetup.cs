...
public static class LocalizationSetup
{
    ...
    static readonly Dictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        { "instr.course",              "Fly through all {0} waypoints!" },
        { "instr.course_hover",        "Hold position in the zone" },
        { "instr.checkpoint_progress", "Checkpoint  {0} / {1}" },
        { "instr.course_complete",     "Course complete!  Now land the helicopter" },
